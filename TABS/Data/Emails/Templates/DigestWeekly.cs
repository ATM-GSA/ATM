...
{
    public class DigestWeekly : ITemplate
    {
        public string GetSubject()
        {
            return "GSA - Condensé hebdomadaire / ATM - Weekly Digest";
        }
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style=""color: #505050; font-size: 16px; padding: 20px; background-color: #ffffff;"">
                                  ...
                                  <p style=""font-family: helvetica;"">Voici vos mises à jour et vos rappels GSA pour le @Model.StartDate au @Model.EndDate.</p>
                                </td>
                              </tr>
                              <tr>
                                <td>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style=""color: #505050; font-size: 16px; padding: 20px; background-color: #ffffff;"">
                                  ...
                                  <p style=""font-family: helvetica;"">Here are your updates and reminders from ATM for @Model.StartDate to @Model.EndDate.</p>
                                </td>
                              </tr>
                              <tr>
                                <td>
